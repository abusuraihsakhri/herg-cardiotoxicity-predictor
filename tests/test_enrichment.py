"""
Automated Pytest for herg-cardiotoxicity-predictor Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    HergcardiotoxicitypredictorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HergcardiotoxicitypredictorEnrichmentSuite()
