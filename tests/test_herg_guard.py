...
import pytest
from herg_guard.models import FrontierPayload, ExecutionStatus
from herg_guard.engine import FrontierDomainEngine
from herg_guard.agents import BasicAminePKaAgent, AromaticHydrophobicFeatureAgent, HERGIC50ClassifierAgent, HERGGuardCoordinator
from herg_guard.cli import main


def test_sub_agents():
    a1 = BasicAminePKaAgent()
    ...
    a2 = AromaticHydrophobicFeatureAgent()
...
def test_coordinator():
    ...
    assert "ICH S7B / E14 Non-Clinical Cardiac Safety" in ans or "specifications" in ans
