...
**Herg Cardiotoxicity Predictor** is an advanced analytical and computational platform implementing hERG potassium channel IC50 & drug-induced Torsades de Pointes arrhythmia agent.
...
docker run -p 8000:8000 herg-cardiotoxicity-predictor
```
